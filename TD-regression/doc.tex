...
les paramètres $\vec{w},b$ inconnus en cherchant à minimiser la somme
des carrés des écarts entre les $y_i$ observés réellement et les prédictions $\hat{y}_i$.
...
\begin{exercice}
  ...
  \item Ce modèle est un réseau de neurones. Dessinez son architecture.
    Combien y a-t-il de couches ? de paramètres (poids) ?
  \end{itemize}
\end{exercice}

\begin{exercice}
  Consultez ce \href{https://colab.research.google.com/drive/1K9mvvRNvWj3MbHmxZZOnIpW1CmZtrt0A?usp=sharing}{notebook}.
  Assurez-vous de comprendre les instructions de la boucle d'apprentissage. Testez en faisant
